...
namespace Architecture {
    ...
    std::unordered_set<RegisterID> get_caller_save_registers() {
        std::unordered_set<RegisterID> caller_save_registers;
        caller_save_registers.insert(RegisterID::r10);
        caller_save_registers.insert(RegisterID::r11);
        caller_save_registers.insert(RegisterID::r8);
        caller_save_registers.insert(RegisterID::r9);
        caller_save_registers.insert(RegisterID::rax);
        caller_save_registers.insert(RegisterID::rcx);
        caller_save_registers.insert(RegisterID::rdi);
        caller_save_registers.insert(RegisterID::rdx);
        caller_save_registers.insert(RegisterID::rsi);
        return caller_save_registers;
    }

    std::unordered_set<RegisterID> get_callee_save_registers() {
        std::unordered_set<RegisterID> callee_save_registers;
        callee_save_registers.insert(RegisterID::r12);
        callee_save_registers.insert(RegisterID::r13);
        callee_save_registers.insert(RegisterID::r14);
        callee_save_registers.insert(RegisterID::r15);
        callee_save_registers.insert(RegisterID::rbp);
        callee_save_registers.insert(RegisterID::rbx);
        return callee_save_registers;
    }
